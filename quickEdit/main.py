...
os.system(".\\vdub.exe /i fixerScript.jobs movie2edit.avi editedMovie.avi") # use virtualDub to cut down and resize the video
os.system('del /f movie2edit.avi') # delete the movie2edit, it's redundant now that the video has been fixed up in virtualDub
